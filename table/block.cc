...
class Block::Iter : public Iterator {
 ...
 public:
  ...
  //   1、先通过二分法在Block的restart[]数组中找到最近的一个restart重启点，这个重启点指向的key < target
  //   2、然后从这个restart重启点指向的key向下遍历，找到大于等于target的Entry。
